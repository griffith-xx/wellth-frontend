...
class UserPreferenceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        auth()->user()->userPreference()->create([
            'health_goals' => $validated['health_goals'],
            'health_conditions' => $validated['health_conditions'],
            'physical_activity_level' => $validated['physical_activity_level'],
            'spa_treatments' => $validated['spa_treatments'],
            'traditional_healing' => $validated['traditional_healing'] ?? [],
            'fitness_programs' => $validated['fitness_programs'] ?? [],
            'preferred_regions' => $validated['preferred_regions'],
            ...
            'nature_preferences' => $validated['nature_preferences'],
            'preferred_climate' => $validated['preferred_climate'],
            'preferred_months' => $validated['preferred_months'],
            ...
            'mobility_requirements' => $validated['mobility_requirements'],
            ...
            'priority_factors' => $validated['priority_factors'],
